...
@implementation WantUAccount
+ (instancetype)accountWithDict:(NSDictionary *)dict
{
    WantUAccount *account = [[self alloc] init];
...
- (void)encodeWithCoder:(NSCoder *)encoder
{
    ...
    [encoder encodeObject:self.created_time forKey:@"name"];
}
...
- (id)initWithCoder:(NSCoder *)decoder
{
    if (self = [super init]) {
        ...
        self.created_time = [decoder decodeObjectForKey:@"name"];
    }
    return self;
}
