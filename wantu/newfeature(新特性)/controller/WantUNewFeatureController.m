//
//  WantUNewFeatureController.m
//  wantu
//
//  Created by 吴新超 on 15/5/20.
//  Copyright (c) 2015年 wuxinchao. All rights reserved.
//

#import "WantUNewFeatureController.h"
#import "WantUTabBarController.h"
#define WXCNewfeatureCount 4
@interface WantUNewFeatureController ()<UIScrollViewDelegate>
@property (nonatomic, weak) UIPageControl *pageControl;

@property (nonatomic, weak) UIScrollView *scrollView;
@end

@implementation WantUNewFeatureController
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i<WXCNewfeatureCount; i++) {
...
//warning 就算不主动添加子控件到scrollView中，scrollView内部还是可能会有一些子控件
    ...
    scrollView.contentSize = CGSizeMake(WXCNewfeatureCount * scrollW, 0);
    ...
    pageControl.numberOfPages = WXCNewfeatureCount;
    pageControl.backgroundColor = [UIColor redColor];
    pageControl.currentPageIndicatorTintColor = WXCColor(253, 98, 42);
    pageControl.pageIndicatorTintColor = WXCColor(189, 189, 189);
...
- (void)startClick
{
    ...
    window.rootViewController = [[WantUTabBarController alloc] init];
